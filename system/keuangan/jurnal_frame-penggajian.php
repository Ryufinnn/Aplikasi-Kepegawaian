<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="156" height="286" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="100" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="85" valign="top"><form name="form1" method="post" action="?page=j-gaji&ok">
              <table width="100%" border="0">
                <tr>
                  <td bgcolor="#F4F4F4"><div align="center">
                    <select name="stts" id="stts" style="width:130px;">
					<?php if(isset($_POST[ssi])){ ?>
					<option value="<?php echo $_POST[stts] ?>"><?php echo "Pegawai ".$_POST[stts] ?></option>
					<?php } else { ?>
    ...
    <td width="803" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="803" height="300" valign="top"><iframe width="100%" src="system/keuangan/jurnal_penggajian.php?stts=<?php echo $_POST[stts] ?>&nip=<?php echo $_POST[nip] ?>&bulan=<?php echo $_POST[bulan] ?>&tahun=<?php echo $_POST[tahun] ?>&ssi=<?php echo $_POST[ssi] ?>" height="300" style="border:1px #BBBBBB solid"></iframe></td>
        </tr>
