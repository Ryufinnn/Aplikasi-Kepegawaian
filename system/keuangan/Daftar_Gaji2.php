...
<table width="766" class="tbls">
  ...
  <tr>
    ...
    <td width="491"><select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
      <?php if($_GET[io]=="Tetap" or $_GET[io]=="Kontrak") { echo"<option value='#'>Guru $_GET[io]</option>"; }
	  else if($_GET[io]=="Buruh") { echo"<option value='#'>$_GET[io]</option>"; }
	  else{?>
      <option value='#'>Pilih Salah Satu</option>
      <?php } ?>
      <option value="?page=d-gaji&io=Tetap">Guru Tetap</option>
      <option value="?page=d-gaji&io=Kontrak">Guru Honorer</option>
