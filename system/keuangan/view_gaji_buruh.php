...
<?php include"koneksi.php"; 
 $sql=mysql_query("select * from daftar_gaji where status_pgw='Buruh'"); 
		...
		$nma=mysql_fetch_array($nm);
		 ...
		 ?>
			<tr align="left" valign="top">
                ...
                <td align="center">
					<a href="?page=u-gaji&id=<?php echo $re[id_gaji]; ?>&io=Buruh">Update</a>	
					<a href="?page=gaji&id=<?php echo $re[id_gaji]; ?>" onClick="return confirm('Apakah Anda yakin menghapus data ini ?')">Delete</a>				</td>															
			</tr><?php }
	 $sql=mysql_query("select * from daftar_gaji where status_pgw='Buruh'"); 
...
if(isset($_GET[id])){
	...
	echo"<meta http-equiv='refresh' content='0;URL=?page=gaji&ok' />";
}
