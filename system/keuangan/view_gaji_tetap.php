...
<table width="100%" border="0" align="center" class="tbls">
  <tr>
    ...
    <td width="191"><div align="center"><strong>Golongan</strong></div></td>
     <td width="191"><div align="center"><strong>Jabatan</strong></div></td>
    <td width="133"><div align="center"><strong>Gaji Pokok</strong></div></td>
	<td width="165"><div align="center"><strong>Tunj.Fungsional</strong></div></td>
 ...
 $sql=mysql_query("select * from daftar_gaji where status_pgw='Tetap'"); 
  ...
  <tr align="left" valign="top">
    ...
    <td><?php echo $fg[nama_tunjangan] ?> </td>
    <td><?php echo "Rp. ".format_rupiah($jbt[gaji_pokok]); ?> </td>
	   <td><?php echo "Rp. ".format_rupiah($fg[tunjangan]); ?> </td>
