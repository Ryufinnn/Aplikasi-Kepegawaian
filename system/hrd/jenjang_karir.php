...
<td>:</td>
 ...
 <tr>
    ...
    <input name="id_jabatan" type="text" /></a></td>
  </tr>
 <tr>
    <td>Jabatan</td>
    <td>:</td>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>Rp</td>
    <td>
        <input type="text" name="gaji" id="gaji" />    </td>
  </tr>
  <tr>
    <td>Keterangan</td>
    <td>:</td>
...
include"koneksi.php";
$sq=mysql_query("insert into jenjang_karir set
							nip='$_POST[nip]',
							...
							echo"<meta http-equiv='refresh' content='0;URL=?page=viewjenjangkarir' />";
}
?>