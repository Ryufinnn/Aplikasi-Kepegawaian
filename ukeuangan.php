    ...
    <div class="Main">
        ...
        <div align="center" id="content">
                ...
                <div class="nav">
                	...
                	<ul class="artmenu">
                		<li><a href="ukeuangan.php" class="{ActiveItem}"><span class="l"></span><span class="r">
                		...
                		<li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Data Gaji</span></a>
                			...
                			<ul>
                                ...
                                <li><a href="?page=cetak_laporan">Laporan Gaji </a></li>
								 <li><a href="?page=laporan_bulanan">Laporan Slip Gaji </a></li>
                		...
                		<li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Setting</span></a>
                			...
                			<ul>
                                ...
                                <li><a href="?page=edit_operator">Edit Password </a></li>
