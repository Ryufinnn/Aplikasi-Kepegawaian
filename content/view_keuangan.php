		 ...
		 while($re=mysql_fetch_array($sql)){ ?>
			<tr align="left" valign="top">
                ...
                <td align="center" bgcolor="#CCCCCC">
					...
					<a href="delete_hrd.php?id=<?php echo $data[0]; ?>">Delete</a>				</td>															
			</tr>
		<?php }?>  
</table>
<br/>
<br/>
<br/>
<div align="right"><a href="?page=t_keuangan" class="button">Tambah Data Keuangan</a></div>
	<p>&nbsp;</p>
<?php
@$foto=$_GET['foto'];
@$id=$_GET['id'];
if(isset($id)){
	$query = mysql_query("select * from keuangan where nip = '$id'");
