...
.style4 {color: #DD0000}
  ...
  <script language="javascript">
   function slcpgwTetap(pg1,pg2,pg3,pg4,pg5,pg6,pg7,pg8,pg9,pg10,pg11){
	   window.parent.slcpgwTetap(pg1,pg2,pg3,pg4,pg5,pg6,pg7,pg8,pg9,pg10,pg11);
...
<div class="kop_header"><span class="style3">Data Guru Honorer</span> <br> 
  <br>
</div>
...
if(isset($_POST[g])){
 ...
 ?>
    <tr>
      <td><div align="center">
	<a href="javascript:slcpgwTetap('<?php echo $k[nip];?>','<?php echo $k[nama];?>','<?php echo $k[id_jabatan];?>','<?php echo $p[nama_jabatan];?>','<?php echo $k[id_departemen];?>','<?php echo $dp[nama_departemen];?>','<?php echo $p[tunjangan];?>','<?php echo $p[gaji_pokok];?>','<?php echo $tnjhrTua;?>','<?php echo $tnjkecl;?>','<?php echo $tnjkmtian;?>','<?php echo $tnjkesehtn;?>','<?php echo $totlsh;?>')">
		  <?php echo $k[nip];?>  </a>
	  </div></td>
      <td><div align="center">
		  <?php echo $k["nama"];?>
