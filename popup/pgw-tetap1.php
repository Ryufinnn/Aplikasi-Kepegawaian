...
if(isset($_POST[g])){
	...
	$z=mysql_query("select * from pegawai_tetap order by nip asc");
		...
		$no++;
	$jbt=mysql_query("select * from jabatan where nama_jabatan='$k[id_jabatan]'");
		$p=mysql_fetch_array($jbt);
		$asc=mysql_query("select * from tunj_fungsional where id_tunj_fungsional='$k[id_tunj_fungsional]'");
 ...
 ?>
    <tr>
      <td><div align="center">
	<a href="javascript:slcpgwTetap('<?php echo $k[nip];?>','<?php echo $k[nama];?>','<?php echo $k[id_jabatan];?>','<?php echo $p[nama_jabatan];?>','<?php echo $k[id_tunj_fungsional];?>','<?php echo $c[nama_tunjangan];?>','<?php echo $c[tunjangan];?>','<?php echo $p[gaji_pokok];?>','<?php echo $tnjhrTua;?>','<?php echo $tnjkesehtn;?>','<?php echo $iuran;?>','<?php echo $pjk;?>','<?php echo $total;?>','<?php echo $totlsh;?>')">
		  <?php echo $k[nip];?>  </a>
	  </div></td>
      <td><div align="center">
		  <?php echo $k["nama"];?>
