...
<table id="rpt" border="0" cellpadding="1" cellspacing="1" width="100%">
  <tbody>
    ...
    <tr>
      <td width='17%'><div align="center"><strong>Nama Departemen </strong></div></td>
      <td width='55%'><div align="center"><strong>Section</strong></div></td>
    </tr>
<?php
include"../koneksi.php";
	$z=mysql_query("select * from departemen order by id_departemen asc");	
 ...
 ?>
    <tr>
      <td><div align="center">
	<a href="javascript:slcdept('<?php echo $k[id_departemen];?>','<?php echo $k[nama_departemen];?>')">
		  <?php echo $k[id_departemen];?>  </a>
	  </div></td>
      <td><div align="center">
		  <?php echo $k["nama_departemen"];?>
		  </div></td>
    </tr>
