...
.style4 {color: #DD0000}
  ...
  <script language="javascript">
   function slctunj_fungsional1(a1,a2){
	   window.parent.slctunj_fungsional1(a1,a2);
	   window.parent.tb_remove();
   }
  </script>
  <hr />
<div class="kop_header"><span class="style3">Data Tunjangan Fungsional</span> <br> 
  <br>
</div>
<table id="rpt" border="0" cellpadding="1" cellspacing="1" width="100%">
  <tbody>
    ...
    <tr>
      <td width='17%'><div align="center"><strong>ID Tunjangan</strong></div></td>
      <td width='55%'><div align="center"><strong>Nama Tunjangan </strong></div></td>
    </tr>
<?php
include"../koneksi.php";
	$z=mysql_query("select * from tunj_fungsional order by id_tunj_fungsional asc");
 ...
 ?>
    <tr>
      <td><div align="center">
	<a href="javascript:slctunj_fungsional1('<?php echo $k[id_tunj_fungsional];?>','<?php echo $k[nama_tunjangan];?>')">
		  <?php echo $k[id_tunj_fungsional];?>  </a>
	  </div></td>
      <td><div align="center">
		  <?php echo $k["nama_tunjangan"];?>
		  </div></td>
    </tr>
