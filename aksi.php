...
elseif ($page=='anggota' AND $act=='update'){
  ...
  // Apabila password diubah
   ...
   echo"<script>alert('Data Anda Sukses Tersimpan');window.location.href='./'</script>";
    }else{
	move_uploaded_file($tmp, $upload_path.$file);
	 mysql_query("UPDATE pegawai_tetap set 
  ...
  // Apabila password diubah
   ...
   echo"<script>alert('Data Anda Sukses Tersimpan');window.location.href='ukeuangan.php'</script>";
   }
}
elseif ($page='gaji' AND $act=='update'){
  // Apabila password tidak diubah
  
    mysql_query("UPDATE daftar_gaji set 
                                  nip='$_POST[nip]',
								  nama='$_POST[nama]', jabatan='$_POST[departemen]',
								  uang_lembur='$_POST[lembur]',
								  bonus='$_POST[hari_raya]',potongan='$_POST[potongan]',
								 gaji_kotor ='$_POST[TxtTotal]'
								
								  
								    
								   WHERE id_gaji = '$_POST[id]'");
  
  // Apabila password diubah
 
   echo"<script>alert('Data Anda Sukses Tersimpan');window.location.href='uhrd.php?page=data_gaji'</script>";
}
